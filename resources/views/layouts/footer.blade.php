...
<!--plugins-->
<script src="assets/js/jquery.min.jss"></script>
<!--plugins-->
<script src="assets/plugins/perfect-scrollbar/js/perfect-scrollbar.jss"></script>
<script src="assets/plugins/metismenu/metisMenu.min.jss"></script>
<script src="assets/plugins/apexchart/apexcharts.min.jss"></script>
<script src="assets/plugins/simplebar/js/simplebar.min.jss"></script>
<script src="assets/plugins/peity/jquery.peity.min.jss"></script>
<script>
  $(".data-attributes span").peity("donut")
</script>
<script src="assets/js/main.jss"></script>
<script src="assets/js/dashboard1.jss"></script>
<script>
...
<!-- Mirrored from codervent.com/maxton/demo/vertical-menu/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Jul 2024 11:25:44 GMT -->
</html>